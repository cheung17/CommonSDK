package com.commonsdk.view.toast;
...
public class Toasty {
    ...
    @ColorInt
    private static int BACK_GROUND_DRAWABLE = R.drawable.toast_frame;
    ...
    @CheckResult
    public static Toast successWithIconAndBg(@NonNull Context context, @NonNull CharSequence message, int duration, @DrawableRes int iconRes, Drawable background) {
        return custom(context, message, ToastyUtils.getDrawable(context, iconRes),
                duration, true, background);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        drawableFrame = ToastyUtils.getDrawable(context, BACK_GROUND_DRAWABLE);

        return custom(context, message, icon, duration, withIcon, drawableFrame);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               @ColorInt int tintColor, int duration,
                               boolean withIcon, Drawable backgroundDrawable) {

        return custom(context, message, icon, duration, withIcon, backgroundDrawable);
    }
    ...
    @SuppressLint("ShowToast")
    @CheckResult
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, int iconRes,
                               int duration,
        ...
        final TextView toastTextView = (TextView) toastLayout.findViewById(R.id.toast_text);
        ToastyUtils.setBackground(toastLayout, backGround);
        ToastyUtils.setBackground(toastIcon, ToastyUtils.getDrawable(context, iconRes));
        toastTextView.setText(message);
    ...
    public static class Config {
        ...
        private int backgroundDrawable = Toasty.BACK_GROUND_DRAWABLE;
        ...
        public Config setBackgroundDrawable(int backgroundDrawable) {
        ...
        public static void reset() {
            ...
            Toasty.BACK_GROUND_DRAWABLE = R.drawable.toast_frame;
            Toasty.textSize = 16;
        ...
        public void apply() {
            ...
            Toasty.BACK_GROUND_DRAWABLE = backgroundDrawable;
        }
    }
}
