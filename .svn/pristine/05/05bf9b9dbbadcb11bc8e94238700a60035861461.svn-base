...
public class OpenEverTypeFile {
     ...
     * @param filePath 文件路径
     */
    public static void startActivityForOpenFile(Context context, String filePath) {
        try {
            context.startActivity(openFile(filePath));
        } catch (Exception e) {
    ...
    public static Intent openFile(String filePath) {
        ...
        String end = filePath.substring(start + 1);
        return openFile(filePath, end);
    }
     ...
     * @return Intent。
     */
    public static Intent openFile(String filePath, String end) {
        File file = new File(filePath);
        if (file == null || !file.exists() || TextUtils.isEmpty(end)) {
            return null;
        }
        if (end.equals("m4a") || end.equals("mp3") || end.equals("mid") || end.equals("xmf") || end.equals("ogg") || end.equals("wav")) {
            ...
            return getAllIntent(filePath, end);
        }
    }
     ...
     * @return Intent。
     */
    public static Intent getAllIntent(String param, String end) {
        MimeTypeMap map = MimeTypeMap.getSingleton();
        ...
        intent.setAction(Intent.ACTION_VIEW);
        Uri uri = Uri.fromFile(new File(param));
        intent.setDataAndType(uri, map.getMimeTypeFromExtension(end));
        return intent;
    }
    ...
    public static Intent getVcfFileIntent(String param) {
        ...
        intent.putExtra(Intent.EXTRA_STREAM, param);
        return intent;
    }
