package com.commonsdk.string;


import com.commonsdk.util.ToolUtil;
...
public class StringUtils {
     ...
     *
     * @param str          字符串
     * @param defultReturn 出错时，默认返回的内容
     * @return ascii字符串
     */
    public static String utf8Encode(String str, String defultReturn) {
        if (!isEmpty(str)) {
            return ToolUtil.encodeUrl(str);
        }
        return str;
    }
