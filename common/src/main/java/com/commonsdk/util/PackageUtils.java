...
import com.commonsdk.util.ShellUtils.CommandResult;
 ...
 * <li>{@link PackageUtils#isTopActivity(Context, String)} whether the app whost package's name is packageName is on the top of the stack</li>
...
public class PackageUtils {
     ...
     */
    public static String getUninatllApkPackageName(Context context, String archiveFilePath) {
     ...
     *
     * @param context
     * @param packageName package name of app 应用包名
     * @return
     */
     ...
     */
    public static Boolean isTopActivity(Context context, String packageName) throws Exception {
        ...
        List<RunningTaskInfo> tasksInfo = activityManager.getRunningTasks(1);
        if (ListUtils.isEmpty(tasksInfo)) {
            throw new Exception("RunningTaskInfo is null .");
        }
        try {
