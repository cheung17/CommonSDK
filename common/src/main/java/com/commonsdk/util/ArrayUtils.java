...
public class ArrayUtils {
     ...
     * @param value        value of target element 需要查找的值
     * @param defaultValue default return value 默认返回值
     * @param isCircle     whether is circle 是否循环
     * @return 得到数组value之前的一个值
     */
